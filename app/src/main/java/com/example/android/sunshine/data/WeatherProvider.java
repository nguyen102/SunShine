...
public class WeatherProvider extends ContentProvider {
  ...
  static {
    ...
    //Automatically fills out the "FROM" section in a SQL query
  ...
  public Uri insert(Uri uri, ContentValues values) {
    ...
    //Do this to notify all the registered observers to the uri that there was a change to the database
